...
def main():
    ...
    if uploaded_image is not None:
        ...
        model_path = "modelsnew/model.keras"  # Replace with the actual path
        tokenizer_path = "modelsnew/tokenizer.pkl"  # Replace with the actual path
        feature_extractor_path = "modelsnew/feature_extractor.keras"  # Replace with the actual path
